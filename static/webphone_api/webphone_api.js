...
var parameters = {
    ...
    rejectonbusy: false,
    calltimeout: 54000000,
    mediatimeout: 0,
    brandname: 'ActuassurConseil',
    video: '0',
    enginepriority_java: 0,
    enginepriority_webrtc: 0,
    enginedpriority_flash: 0,
    enginepriority_ns: 5,
    enginepriority_app: 0,
    enginepriority_p2p: 0,
    enginepriority_callback: 0,
...
{
    if (typeof (plhandler) === 'undefined' || plhandler === null)
        api_helper.AddToQueue('MuteVideo', [mute, direction]);
    else
...
{
    if (typeof (plhandler) === 'undefined' || plhandler === null)
        api_helper.AddToQueue('SetVideoSize', [type, width, height]);
    else
...
{
    if (typeof (plhandler) === 'undefined' || plhandler === null)
        api_helper.AddToQueue('ScreenShare', [number, screenid]);
    else
...
{
    if (typeof (plhandler) === 'undefined' || plhandler === null)
        api_helper.AddToQueue('StopScreenShare', []);
    else
